...
/**
 * Tab "Cấu hình LLM" trong trang /dfir (chỉ Super Admin).
 * Tách từ /admin/llm-dfir/settings để gộp vào DFIR page.
 * API vẫn gọi /admin/llm-dfir/config + /admin/llm-dfir/config/{models,test}.
 */
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <h3 className="mb-3 flex items-center gap-2 text-sm font-semibold tracking-tight text-slate-800">
              <Database className="size-4 text-slate-400" />
              Backend
            </h3>
